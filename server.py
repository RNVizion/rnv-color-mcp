...
mcp.tool(
    ...
    **_scoped("read"),
    description=(
        ...
        "Reach for paint when BLENDING brand colors into a new one, and lab when "
        "SAMPLING between them: lab averages chroma toward the centroid of its "
        "ingredients, which is right for finding a midpoint and wrong for making a "
